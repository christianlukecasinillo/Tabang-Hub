            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <h2 className="mb-5 text-center text-2xl font-bold text-gray-600">Input all neccessarry fields</h2>
                    ...
                    <form className="space-y-6" action="#" method="POST">
                        ...
                        <div>
                            <div className="md:container text-center">
                                <label for="password" className="block text-sm font-medium leading-6 text-black">Confirm Password</label>
                                
                            </div>
                            <div className="mt-2">
                                <input placeholder='**********' name="confpassword" type="password" autocomplete="current-password"  className="block w-full rounded-md border-0 bg-white/5 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-500 focus:ring-2 focus:ring-inset focus:ring-black sm:text-sm sm:leading-6" style={{ paddingLeft: '12px' }}/>
                            </div>
                        </div>
