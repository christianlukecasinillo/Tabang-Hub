...
export default function Navbar(){
    ...
    return(
      <div className="mt-40 md:container text-center">
        <div>
          <div>
            <h1 className="text-center text-2xl font-bold font-serif leading-9 tracking-tight to-blue-500">Login</h1>
            {/* <h2 className="text-center text-2xl font-sans leading-9 tracking-tight to-blue-500">Login</h2> */}
          </div>
          <br />
          <div className=" sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <p className="mt-5 text-center text-sm text-gray-400">
              ...
              <Link href="/Register" className="font-semibold leading-6 text-white-500 text-blue-500 hover:text-blue-400"> SignUp Here</Link>
            </p>
          </div>
        </div>
      </div>
